...
// Note: eventType is manually set by admins to allow flexibility.
// Admins can override automatic date-based categorization for special cases
// (e.g., keeping a major event as "current" for a few days)
