    ...
    <div className="min-h-screen text-white overflow-hidden">
      ...
      <section className="py-10 relative">
        <div className="container mx-auto px-6 relative">
          <motion.div
            className="max-w-4xl mx-auto rounded-xl border border-zinc-800 bg-zinc-950/60 p-6"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.7 }}
          >
            <h2 className="text-2xl font-bold uppercase mb-3">
              Build With <span className="text-red-600">Zero Error</span>
            </h2>
            <p className="text-zinc-300 text-sm mb-5">
              Explore how our leadership, tournaments, services, and community programs connect.
            </p>
