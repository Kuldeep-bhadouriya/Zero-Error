          ...
          >
            <div className="rounded-xl border border-zinc-800 bg-zinc-950/60 p-6">
              <h3 className="text-2xl font-bold uppercase mb-3">
                Explore <span className="text-red-500">Zero Error</span>
              </h3>
              <p className="text-zinc-300 text-sm mb-5">
                Navigate deeper into our ecosystem through services, events, and
                team culture.
              </p>
            ...
            <div className="rounded-xl border border-zinc-800 bg-zinc-950/60 p-6">
              <h3 className="text-2xl font-bold uppercase mb-4">About FAQ</h3>
