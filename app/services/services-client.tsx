      ...
      <section className="relative py-8 sm:py-12 pb-20 sm:pb-32">
        ...
        >
          <div className="rounded-xl border border-zinc-800 bg-zinc-950/60 p-6">
            <h2 className="text-2xl font-bold uppercase mb-3 font-orbitron">
              Related <span className="text-red-600">Paths</span>
            </h2>
            <p className="text-zinc-300 text-sm mb-5">
              Discover where each service connects with your growth journey.
            </p>
          ...
          <div className="rounded-xl border border-zinc-800 bg-zinc-950/60 p-6">
            <h2 className="text-2xl font-bold uppercase mb-4 font-orbitron">
              Services FAQ
            </h2>
