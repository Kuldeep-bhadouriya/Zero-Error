...
export default function EventsPage({ initialUpcomingEvents, initialPastEvents }: EventsPageProps) {
      ...
      <section className="relative h-[400px] overflow-hidden pt-0 md:pt-24">
        ...
        <div className="absolute inset-0">
          <Image
            ...
            alt="Zero Error Esports events banner showcasing tournaments and community competitions"
            fill
            priority
            sizes="100vw"
            ...
            >
              ...
              <div className="relative w-full aspect-square overflow-hidden max-h-80">
                ...
                <Image
                  ...
                  alt="ZE SLAMMANIA WWE 2K25 event poster"
                  fill
                  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 25vw"
                  className="object-cover group-hover:scale-105 transition-transform duration-500"
                />
            ...
            >
              ...
              <div className="relative w-full aspect-square overflow-hidden max-h-80">
                ...
                <Image
                  ...
                  alt="EAFC SHOWDOWN football esports event poster"
                  fill
                  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 25vw"
                  className="object-cover group-hover:scale-105 transition-transform duration-500"
                />
            ...
            >
              ...
              <div className="relative w-full aspect-square overflow-hidden max-h-80">
                ...
                <Image
                  ...
                  alt="ZE FFM SHOWDOWN Free Fire Max event poster"
                  fill
                  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 25vw"
                  className="object-cover group-hover:scale-105 transition-transform duration-500"
                />
            ...
            >
              ...
              <div className="relative w-full aspect-square overflow-hidden max-h-80">
                ...
                <Image
                  ...
                  alt="ZE FACEOFF Invitational BGMI tournament poster"
                  fill
                  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 25vw"
                  className="object-cover group-hover:scale-105 transition-transform duration-500"
                />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            >
              <h2 className="text-2xl font-black uppercase mb-3">
                Plan Your <span className="text-red-600">Journey</span>
              </h2>
              <p className="text-zinc-300 text-sm mb-5">
                Move from watching events to joining the full Zero Error ecosystem.
              </p>
              <div className="flex flex-wrap gap-3 text-sm">
                <Link href="/join-us" className="text-red-400 hover:text-red-300 underline underline-offset-4">
                  Join as Player or Volunteer
                </Link>
            ...
            >
              <h2 className="text-2xl font-black uppercase mb-4">Events FAQ</h2>
              <div className="space-y-4">
                {eventsFaqs.map((faq) => (
                  <div key={faq.question}>
                    <h3 className="text-base font-semibold text-white">{faq.question}</h3>
                    <p className="text-sm text-zinc-300 mt-1">{faq.answer}</p>
                  </div>
                ))}
              </div>
            </motion.div>
